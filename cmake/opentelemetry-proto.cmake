...
string(REPLACE ";" " " PROTOBUF_RUN_PROTOC_ARGS_DISPLAY "${PROTOBUF_RUN_PROTOC_ARGS}")

if(TARGET protobuf::protoc)
  set(protoc_command protobuf::protoc)
  if(${CMAKE_VERSION} VERSION_LESS "3.26")
    set(protoc_command_display protoc)
  else()
    set(protoc_command_display "$<TARGET_FILE:protobuf::protoc>")
  endif()
else()
  set(protoc_command ${PROTOBUF_PROTOC_EXECUTABLE})
  set(protoc_command_display ${PROTOBUF_PROTOC_EXECUTABLE})
endif()
add_custom_command(
  OUTPUT ${PROTOBUF_GENERATED_FILES}
  COMMAND ${protoc_command} ${PROTOBUF_RUN_PROTOC_ARGS}
  COMMENT "[Run]: ${protoc_command_display} ${PROTOBUF_RUN_PROTOC_ARGS_DISPLAY}")
